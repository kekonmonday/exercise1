 ...
 */
@Entity
@Table(name = "date", catalog = "exercise4", schema = "")
@XmlRootElement
@NamedQueries({
    ...
    , @NamedQuery(name = "Date.findByDate", query = "SELECT d FROM Date d WHERE d.date = :date")})
public class Date implements Serializable {
    ...
    public String toString() {
        return "com.mycompany.mavenproject3.Date[ id=" + id + " ]";
    }
